...
def get_version():
    init_py_path = path.join(path.abspath(path.dirname(__file__)), "cvmatrix", "__init__.py")
...
def get_model_zoo_configs() -> List[str]:
    ...
    destination = path.join(
        path.dirname(path.realpath(__file__)), "cvmatrix", "model_zoo", "configs"
    )
...
# to cvmatrix's core functionalities, we install them under cvmatrix.projects
PROJECTS = {
    "cvmatrix.projects.point_rend": "projects/PointRend/point_rend",
    "cvmatrix.projects.deeplab": "projects/DeepLab/deeplab",
    "cvmatrix.projects.panoptic_deeplab": "projects/Panoptic-DeepLab/panoptic_deeplab",
}
...
setup(
    ...
    version=get_version(),
    author="GuanHeng",
    url="https://github.com/hengguan/cvmatrix",
    description="cvmatrix is myself research platform depend on Detectron2 for 2d and 3d perception.",
    ...
    extras_require={
        ...
        # dev dependencies. Install them by `pip install 'cvmatrix[dev]'`
        "dev": [
            "flake8==3.8.1",
            "isort==4.3.21",
            "flake8-bugbear",
