...
__all__ = ["LazyCall", "LazyConfig", "dump_dataclass", "instantiate"]
...
class LazyCall:
    ...
    Examples:
    ::
        from cvmatrix.config import instantiate, LazyCall
...
_CFG_PACKAGE_NAME = "cvmatrix._cfg_loader"
"""
...
class LazyConfig:
    ...
    @staticmethod
    def apply_overrides_dict(cfg, overrides: Dict):
        """
