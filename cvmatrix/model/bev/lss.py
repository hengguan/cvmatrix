...
class LiftSplatShoot(nn.Module):
    ...
    def forward(self, image, rots, trans, intrins, post_rots, post_trans):
        x = self.get_voxels(image, rots, trans, intrins, post_rots, post_trans)
        x = self.bevencode(x)
        return x
...
class LSS(nn.Module):
    ...
    def __init__(self, grid_conf, data_aug_conf, num_classes, losses, **kwargs):
        super(LSS, self).__init__()

        self.model = LiftSplatShoot(grid_conf, data_aug_conf, num_classes)
