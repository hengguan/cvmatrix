...
# from cvmatrix.evaluation.testing import flatten_results_dict
# from cvmatrix.solver import LRMultiplier
from cvmatrix.utils.events import EventStorage, EventWriter
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    """
    Same as :class:`cvmatrix.checkpoint.PeriodicCheckpointer`, but as a hook.
    ...
    def after_step(self):
        ...
        if not self._save_tensorboard:
            ...
            if "://" not in out_file:
                ...
                with tempfile.TemporaryDirectory(prefix="cvmatrix_profiler") as d:
